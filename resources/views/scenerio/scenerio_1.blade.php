...
@section('body')
            ...
            <td style="border-top: solid 1px #08683a; border-bottom: solid 1px #08683a; padding: 5px 0px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td style="font-size: 32px; line-height: 36px; color: #08683a; font-weight: bold; text-align: center; font-family: 'kruti_dev_010regular';">शाबाश {{ strtoupper($type) }}
                            <?php
                               if($type == 'anm'){
                            ?>
                            दीदी </td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
        <tr>
            ...
            <td align="center" style="font-weight: bold;" class="d-block">
				...
				<p style="color: #000; font-size: 14px; line-height: 24px; margin:0;">आपने मार्च में अव्वल दर्जे का काम कर दिखाया! आप में से कुछ {{ strtoupper($type) }}s ने 80% बच्चो का टीकाकरण पूरा कर दिखाया तथा कुछ ने 30% गर्भवती महिलाओ का चौथा ANC चैकप भी पूरा किया!</p>
            </td>
        </tr>
    </table>
        ...
        <tr class="row-reverse">
            <td align="center" style="font-weight: bold;" class="d-block">
                <span style="color: #ec1d25; font-size: 20px;">
                    ...
                    {{--@endif--}}
                <span>
                <p style="color: #000; font-size: 14px; line-height: 24px; margin:0;"><?php
                    if($type == 'anm'){
                    ?>
                    दीदी
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; padding: 30px 0 10px;">
        <tr>
            <td align="left" valign="middle" class="d-block"><img src="{{ asset('images/newsletter-img/pic3-left.jpg') }}" alt="" alt=""></td>
            <td align="center" style="font-weight: bold;" class="d-block">
				<span style="color: #ec1d25; font-size: 20px;">
                    {{--@if($type != 'beneficiary')--}}
                 ...
                 <span>
				<p style="color: #000; font-size: 14px; line-height: 21px; margin:0;">आपको भी 80% बच्चो का टीकाकरण एवं 30% से भी अधिक गर्भवती महिलाओ का चौथा ANC करके दिखाना है| थोड़ी और तैयारी करो| </p>
            </td>
        </tr>
    </table>
