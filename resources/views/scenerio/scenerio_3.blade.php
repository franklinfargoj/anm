            ...
            <td style="border-top: solid 1px #08683a; border-bottom: solid 1px #08683a; padding: 5px 0px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td style="font-size: 32px; line-height: 36px; color: #08683a; font-weight: bold; text-align: center;">शाबाश
                            {{ strtoupper($type) }}
                            <?php
                            if($type == 'anm'){
                            ?>
        ...
        <tr>
            ...
            <td align="center" style="font-weight: bold;">
                @if(isset($lstData['TOP']['anm_name']) && count($lstData['TOP']['anm_name']) > 0)
                    ...
                    @else
                                    <span style="color: #ec1d25; font-size: 20px;"> {{ $lstData['TOP']['end'] }}<span>
                    @endif
				<p style="color: #000; font-size: 14px; line-height: 24px; margin:0;" class="">आपने {{$current_month}} में अव्वल दर्जे का काम कर दिखाया! आप में से कुछ {{ strtoupper($type) }}s ने 80% बच्चो का टीकाकरण पूरा कर दिखाया तथा कुछ ने 30% गर्भवती महिलाओ का चौथा ANC चैकप भी पूरा किया!</p>
            </td>
        </tr>
    </table>
