...
@section('content')
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Patient Feedback</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Upload Feedback File</h3>
                </div>
            </div>
        </div>
    </section>

    {!!  Form::open(array('route' => 'import.feedback','method'=>'POST','files'=>'true','enctype'=>"multipart/form-data")) !!}
    <section>
        <div class="container">
            <div class="row">
    ...
    <script>
        $(function () {
            ...
            $('#uploadData').dataTable({
                ...
                "ordering": false,
                "info": true,
                "ajax": "<?php echo url('/feedback_files');?>",
                "columns": [
                    { "data": "sr_no" },
                    { "data": "og_filename" },
                    { "data": "created_at" },
