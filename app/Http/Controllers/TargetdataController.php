                        ...
                        if($value["performer_category"] == "TOP"){
                            if(str_contains($value['anm_name_hindi'], ',')){
                                ...
                                foreach ($separated as $single) {
                                    $msg .= rtrim($single, ' ') .' '.'दीदी बधाई हो!8०% से अधिक बच्चों का टीकाकरण तथा ३०% से अधिक गर्भवती महिलाओं के चार ANC चेकप कर दिखाने पर -'.' '
                                            .$months[$request->get('month')] .' '.'के महीने में आपने, अपने PHC सेक्टर में अव्वल दर्जे  का काम कर दिखाया।हमें पूरी उम्मीद है कि आप अगले महीने भी इसी तरह काम करेंगे तथा साथ ही साथ अपने क्षेत्र की सभी ANMsके लिए भी मार्गदर्शक बनते
                                              हुए उन्हें और बेहतर काम करने के लिए बढ़ावा देंगी!बने रहिये -आप हम सब के लिए एक मिसाल हैं!जानने के लिए कि'.' '.$months[$request->get('month')].' '. 'की महीने में PHC' .' '.$obj->convert_to_unicode2($value['phc_name_hindi']).' '.'ANMsने कैसा काम किया, नीचे दिए गए लिंक पर क्लिक कीजिए:==';
                                }
                            }else{
